                ...
                <div key={index} className='p-3 break-inside-avoid  w-full'>
                  ...
                  <Card className='shadow-sm' key={index}>
                    <CardHeader className='flex flex-row items-start justify-between space-y-0 pb-2'>
                      ...
                      <h3 className='font-medium  text-left w-full'>{data.title}</h3>
                      </div>
                    ...
                    <CardContent>
                      ...
                      <div >
                        {isYoutubeVid(data.link) && <div><YouTubeComp url={data.link} /></div>}
                      
                        {isTweet(data.link) && <div className='w-full'><TwitterComp tweetUrl={refineTweetUrl(data.link)} /></div>}
                      </div>
